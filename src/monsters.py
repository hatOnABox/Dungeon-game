...
bat = monster({'name' : 'bat', 'hp': 8, 'actionsNum': 1, 'actions':{'atk':{'bite': 3, 'claw': 4}}, 'speed': 4, 'xpGain': 2})
bear = monster({'name': 'Brown Bear', 'hp':20, 'actionsNum': 1, 'actions':{'atk':{'bite':4, 'claw':6}}, 'speed':6,'xpGain':20})
...
noviceNecromancer = monster({'name': 'novice necromancer', 'hp': 25, 'actionsNum': 2, 'actions':{'atk':{'ice spike': 5, 'undead hand': 5}}, 'speed':4, 'xpGain': 25})
